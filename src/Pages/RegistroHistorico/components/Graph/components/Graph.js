...
function Graph({ plotData, summary, downloadCSV }) {
      ...
      <Row className="mb-5">
        <Col xs={12} lg={4} xl={2}>
          <Row xs={12}>
            ...
            >
              Descargar un CSV con los datos 
            </Button>
          </Row>
          <Row className="d-flex justify-content-center">
            <Col xs={6} sm={5} lg={12}>
              <Row className="dato-calculado d-flex justify-content-center">
                ...
                <Row sm={12} className="d-flex align-items-center justify-content-end">
            ...
            <Col xs={6} sm={5} lg={12}>
              <Row className="dato-calculado d-flex align-items-center justify-content-center">
                <Row sm={12} className="d-flex align-items-center justify-content-center">
                  <p className="tipo text-center">Arriba de la norma</p>
                </Row>
                <Row sm={12} className="d-flex align-items-center justify-content-center">
                  <p
                    className={`numero text-center ${
                      summary
